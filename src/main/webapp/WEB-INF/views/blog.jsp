                    ...
                    <ul class="nav navbar-nav menu_nav ml-auto">
                        ...
                        <li class="nav-item submenu dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="nav-item"><a class="nav-link" href="/product_details">Product Details</a></li>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="categories_post">
                    <img src="${pageContext.request.contextPath}/resources/img/blog/cat-post/cat-post-3.jpg" alt="post">
            ...
            <div class="col-lg-4">
                <div class="categories_post">
                    <img src="${pageContext.request.contextPath}/resources/img/blog/cat-post/cat-post-2.jpg" alt="post">
                    <div class="categories_details">
                        <div class="categories_text">
                            <a href="blog-details.html">
                                <h5>Politics</h5>
            ...
            <div class="col-lg-4">
                <div class="categories_post">
                    <img src="${pageContext.request.contextPath}/resources/img/blog/cat-post/cat-post-1.jpg" alt="post">
                    <div class="categories_details">
                        <div class="categories_text">
                            <a href="blog-details.html">
                                <h5>Food</h5>
            ...
            <div class="col-lg-8">
                <div class="blog_left_sidebar">
                    <article class="row blog_item">
                        ...
                        <div class="col-md-9">
                            <div class="blog_post">
                                <img src="${pageContext.request.contextPath}/resources/img/blog/main-blog/m-blog-1.jpg" alt="">
                                <div class="blog_details">
                                    ...
                                    <a href="/single_blog" class="white_bg_btn">View More</a>
                                </div>
                            </div>
                        </div>
                    </article>
                    <article class="row blog_item">
                        ...
                        <div class="col-md-9">
                            <div class="blog_post">
                                <img src="${pageContext.request.contextPath}/resources/img/blog/main-blog/m-blog-2.jpg" alt="">
                                <div class="blog_details">
                                    <a href="/single_blog">
                    ...
                    <article class="row blog_item">
                        ...
                        <div class="col-md-9">
                            <div class="blog_post">
                                <img src="${pageContext.request.contextPath}/resources/img/blog/main-blog/m-blog-3.jpg" alt="">
                                <div class="blog_details">
                                    <a href="/single_blog">
                    ...
                    <article class="row blog_item">
                        ...
                        <div class="col-md-9">
                            <div class="blog_post">
                                <img src="${pageContext.request.contextPath}/resources/img/blog/main-blog/m-blog-4.jpg" alt="">
                                <div class="blog_details">
                                    <a href="/single_blog">
                                        <h2>The Night Sky</h2>
                                    </a>
                    ...
                    <article class="row blog_item">
                        ...
                        <div class="col-md-9">
                            <div class="blog_post">
                                <img src="${pageContext.request.contextPath}/resources/img/blog/main-blog/m-blog-5.jpg" alt="">
                                <div class="blog_details">
                                    <a href="/single_blog">
            ...
            <div class="col-lg-4">
                <div class="blog_right_sidebar">
                    ...
                    <aside class="single_sidebar_widget author_widget">
                        <img class="author_img rounded-circle" src="${pageContext.request.contextPath}/resources/img/blog/author.png" alt="">
                    ...
                    <aside class="single_sidebar_widget popular_post_widget">
                        ...
                        <div class="media post_item">
                            <img src="${pageContext.request.contextPath}/resources/img/blog/popular-post/post1.jpg" alt="post">
                        ...
                        <div class="media post_item">
                            <img src="${pageContext.request.contextPath}/resources/img/blog/popular-post/post2.jpg" alt="post">
                            <div class="media-body">
                                <a href="blog-details.html">
                        ...
                        <div class="media post_item">
                            <img src="${pageContext.request.contextPath}/resources/img/blog/popular-post/post3.jpg" alt="post">
                            <div class="media-body">
                                <a href="blog-details.html">
                        ...
                        <div class="media post_item">
                            <img src="${pageContext.request.contextPath}/resources/img/blog/popular-post/post4.jpg" alt="post">
                            <div class="media-body">
                                <a href="blog-details.html">
                    ...
                    <aside class="single_sidebar_widget ads_widget">
                        <a href="#"><img class="img-fluid" src="${pageContext.request.contextPath}/resources/img/blog/add.jpg" alt=""></a>
                        <div class="br"></div>
                    </aside>
