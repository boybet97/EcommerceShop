            ...
            <div class="col-lg-6">
                <div class="login_form_inner">
                    ...
                    <form:form method="post" action="/register" modelAttribute="registerForm">
                        <form:label path="email"  cssStyle="font-size: x-large" >Email Address* </form:label>
                        <br>
                        <form:input path="email" cssStyle="font-size: x-large" />
                        <form:errors path="email" cssStyle="color: red"/>
                        <br>
                        <form:label path="password" cssStyle="font-size: x-large">Password* </form:label>
                        <br>
                        <form:password path="password" cssStyle="font-size: x-large"/>
                        <form:errors path="password" cssStyle="color: royalblue"/>
                        <br>
                        <form:label path="confirm_password" cssStyle="font-size: x-large">Confirn password* </form:label>
                        <br>
                        <form:password path="confirm_password" cssStyle="font-size: x-large"/>
                        <form:errors path="confirm_password" cssStyle="color: rebeccapurple"/>
                        <br>
                        <form:label path="first_name" cssStyle="font-size: x-large">First name* </form:label>
                        <br>
                        <form:input path="first_name" cssStyle="font-size: x-large"/>
                        <form:errors path="first_name" cssStyle="color: rosybrown"/>
                        <br>
                        <form:label path="last_name" cssStyle="font-size: x-large">Last name* </form:label>
                        <br>
                        <form:input path="last_name" cssStyle="font-size: x-large"/>
                        <form:errors path="last_name" cssStyle="color: rosybrown"/>
                        <br>
                        <form:label path="phone_number" cssStyle="font-size: x-large">Phone number* </form:label>
                        <br>
                        <form:input path="phone_number" cssStyle="font-size: x-large"/>
                        <form:errors path="phone_number" cssStyle="color: rebeccapurple"/>
                        <br>
                        <form:label path="gender" cssStyle="font-size: x-large">Gender* </form:label>
                        <br>
